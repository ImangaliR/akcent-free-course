                  ...
                  <div key={index} className="mb-3">
                    ...
                    {option.isCorrect && (
                      <button
                        ...
                        className="mt-3 w-full p-3 text-left rounded-lg border border-gray-300 hover:border-blue-400 hover:bg-blue-50 bg-gray-50 hover:shadow-sm cursor-pointer text-gray-800 transition-all duration-200"
                      >
                  ...
                  <button
                    ...
                    className={`w-full p-3 text-left rounded-lg border transition-all duration-200 ${
                      isProcessing
                        ...
                        : "border-gray-300 hover:border-blue-400 hover:bg-blue-50 bg-gray-50 hover:shadow-sm cursor-pointer text-gray-800"
                    }`}
                  >
